...
export default function frontPage(){
    ...
    <FrontInfo/>
    <Bottombar/>
    <header className="p-10 text-white text-2xl font-bold z-30">Velkommen</header>
    <p className="text-black text-5xl z-30">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
